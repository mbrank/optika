...
ray_t camera_get_ray(camera *cam, double u, double v){
  ...
  PV_t dir;
  //printf("cam->lower_left_corner.x: %f\n", cam->lower_left_corner.x);
  //printf("cam->lower_left_corner.y: %f\n", cam->lower_left_corner.y);
  //printf("cam->lower_left_corner.z: %f\n", cam->lower_left_corner.z);
  //printf("cam->vertical.x: %f\n", cam->vertical.x);
  //printf("cam->vertical.y: %f\n", cam->vertical.y);
  //printf("cam->vertical.z: %f\n", cam->vertical.z);
  //printf("cam->camera_origin.x: %f\n", cam->camera_origin.x);
  //printf("cam->camera_origin.y: %f\n", cam->camera_origin.y);
  //printf("cam->camera_origin.z: %f\n", cam->camera_origin.z);
  //printf("u: %f\n", u);
  //printf("v: %f\n", v);
